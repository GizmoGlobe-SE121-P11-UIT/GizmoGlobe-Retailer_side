...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(name) => "Are you sure you want to activate ${name}?";

  static String m1(status) =>
      "Are you sure you want to change the status to ${status}?";

  static String m2(name) => "Are you sure you want to deactivate ${name}?";

  static String m3(field) => "Enter ${field}";

  static String m4(error) => "Error creating warranty invoice: ${error}";

  static String m5(error) => "Error loading invoice details: ${error}";

  static String m6(error) => "Error loading warranty invoice details: ${error}";

  static String m7(error) => "Error: ${error}";

  static String m8(email) => "A password reset email will be sent to ${email}";

  static String m9(field) => "Select ${field}";

  static String m10(email) => "Email: ${email}";

  static String m11(role) => "Role: ${role}";

  static String m12(id) => "Student ID: ${id}";

  static String m13(id) => "Warranty #${id}";

  final messages = _notInlinedMessages(_notInlinedMessages);
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    "aboutGizmoGlobe": MessageLookupByLibrary.simpleMessage("About GizmoGlobe"),
    ...
    "businessHoursTitle": MessageLookupByLibrary.simpleMessage(
      "Business Hours",
    ),
    ...
    "employeeDetail": MessageLookupByLibrary.simpleMessage("Employee Detail"),
    ...
    "findEmployees": MessageLookupByLibrary.simpleMessage("Find employees..."),
    ...
    "manufacturerName": MessageLookupByLibrary.simpleMessage("Name"),
    ...
    "notEnoughStock": MessageLookupByLibrary.simpleMessage("Not enough stock"),
