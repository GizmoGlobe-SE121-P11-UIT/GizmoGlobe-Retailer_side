const Map<String, String> vi = {
  ...
  'createIncomingInvoiceSuccess': 'Tạo phiếu nhập thành công.',
  'updateIncomingInvoiceSuccess': 'Cập nhật phiếu nhập thành công.',
  'searchIncomingInvoices': 'Tìm phiếu nhập...',
  'noIncomingInvoicesFound': 'Không tìm thấy phiếu nhập',
  'view': 'Xem',
  ...
  'enableLocationServices': 'Bật dịch vụ vị trí trong Cài đặt',
  'noLocationsAvailable': 'Không có địa điểm nào',
  'clickPlusToAddMore': 'Nhấp vào biểu tượng + để thêm',
  // Rating and Reply related
  'reply': 'Trả lời',
  'postReply': 'Đăng trả lời',
  'replyPostedSuccessfully': 'Đã đăng trả lời thành công',
  'failedToPostReply': 'Không thể đăng trả lời: {error}',
  'loadMore': 'Tải thêm',
  'noItems': 'Không có mục nào',
  'writeAReply': 'Viết một trả lời',
  'newRatings': 'Mới',
  ...
  'loading': 'Đang tải...',
  'productInfoLoading': 'Đang tải thông tin sản phẩm',
  'category': 'Danh mục',
  ...
  'employeeUpdatedSuccessfully': 'Nhân viên đã được cập nhật thành công',
  'employeeDeletedSuccessfully': 'Nhân viên đã bị xóa thành công',
  'customerUpdatedSuccessfully': 'Khách hàng đã được cập nhật thành công',
  'manufacturerUpdatedSuccessfully': 'Nhà cung cấp đã được cập nhật thành công',
  'manufacturerDeactivatedSuccessfully': 'Nhà cung cấp đã được vô hiệu hóa thành công',
  'manufacturerActivatedSuccessfully': 'Nhà cung cấp đã được kích hoạt thành công',
  'failedToToggleManufacturerStatus': 'Không thể thay đổi trạng thái nhà cung cấp: {error}',
  'failedToUpdateManufacturer': 'Không thể cập nhật nhà cung cấp: {error}',
  'failedToUpdateEmployee': 'Không thể cập nhật nhân viên: {error}',
  'failedToDeleteEmployee': 'Không thể xóa nhân viên: {error}',
  'failedToUpdateCustomer': 'Không thể cập nhật khách hàng: {error}',
  ...
  'manageProductImages': 'Quản lý hình ảnh sản phẩm',
  'uploadImage': 'Tải ảnh lên',
  'addUrl': 'Thêm URL',
  'primary': 'Ảnh chính',
  'pendingLabel': 'Đang chờ',
  'newLabel': 'Mới',
  'pendingUpload': 'Đang chờ tải lên',
  'closeWithoutSaving': 'Đóng không lưu',
  'selectConversation': 'Chọn cuộc trò chuyện',
  'selectConversationToStart': 'Chọn cuộc trò chuyện để bắt đầu trò chuyện',
  'backToChatList': 'Quay lại danh sách trò chuyện',
  'messages': 'Tin nhắn',
  ...
  'totalIncomingInvoices': 'Tổng số Phiếu nhập',
  ...
  'cpuBaseClock': 'Tốc độ xung nhịp cơ bản CPU (GHz)',
  'cpuTurboClock': 'Tốc độ xung nhịp Turbo CPU (GHz)',
  'cpuTdp': 'TDP CPU (W)',
  'numberOfCpuCores': 'Số nhân CPU',
  'numberOfCpuThreads': 'Số luồng CPU',
  'gpuVersion': 'Phiên bản GPU',
  'gpuMemory': 'Bộ nhớ GPU (GB)',
  'gpuTdp': 'TDP GPU (W)',
  'gpuBoostClock': 'Tốc độ xung nhịp Boost GPU (GHz)',
  'connectorType': 'Loại Kết nối',
  'addConnector': 'Thêm Kết nối',
  'addIoPort': 'Thêm Cổng IO',
  'addPcieSlot': 'Thêm Khe PCIe',
  'driveGeneration': 'Thế hệ Ổ đĩa',
  'chipsetCode': 'Mã Chipset',
  'mainboardFormFactor': 'Form Factor Mainboard',
  'supportedRamType': 'Loại RAM được Hỗ trợ',
  'numberOfSataPorts': 'Số Cổng SATA',
  'numberOfM2Slots': 'Số Khe M.2',
  'physicalSize': 'Kích thước Vật lý',
  ...
  'clLatency': 'Độ trễ CL',
  'maxWattage': 'Công suất Tối đa (W)',
  'psuModularity': 'Tính Mô-đun PSU',
  'port': 'Cổng',
  'thisFieldIsRequired': 'Trường này là bắt buộc',
  'ramBusSpeed': 'Tốc độ Bus RAM (MHz)',
  'maximumSingleRamCapacity': 'Dung lượng RAM Đơn Tối đa (GB)',
  ...
  'version': 'Phiên bản',
  'memory': 'Bộ nhớ',
  'clockSpeed': 'Tốc độ xung nhịp',
  'tdp': 'TDP',
  'ioPorts': 'Cổng I/O',
  'cores': 'Số nhân',
  'threads': 'Số luồng',
  'baseClock': 'Xung nhịp cơ bản',
  'turboClock': 'Xung nhịp Turbo',
  'socket': 'Socket',
  'chipset': 'Chipset',
  'ramSpec': 'Thông số RAM',
  'storage': 'Lưu trữ',
  'pcieSlots': 'Khe PCIe',
  'connectors': 'Bộ kết nối',
  'efficiencyRating': 'Xếp hạng hiệu suất',
