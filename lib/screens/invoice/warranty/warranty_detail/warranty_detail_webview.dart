...
class WarrantyDetailWebView extends StatefulWidget {
  final WarrantyInvoice invoice;

  const WarrantyDetailWebView({
    super.key,
  ...
  static Widget newInstance(WarrantyInvoice invoice) => BlocProvider(
        ...
        child: WarrantyDetailWebView(invoice: invoice),
      );

  @override
  State<WarrantyDetailWebView> createState() => _WarrantyDetailWebViewState();
}

class _WarrantyDetailWebViewState extends State<WarrantyDetailWebView> {
  @override
